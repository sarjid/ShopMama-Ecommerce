...
@section('admin_title') Blogs Sub-Category @endsection
                            ...
                            <table id="datatable1" class="table display responsive nowrap">
                              ...
                              <tbody>                              
                                ...
                                <tr>                              
                                  ...
                                  <td>
                                    {{ $row->PostCategory->category_name_en }}=>
                                  ...
                                  <td>
                                    <a href="{{ url('admin/blogs-sub-category-edit/'.$row->id) }}" class="btn btn-sm btn-primary" title="edit data"> <i class="fa fa-pencil"></i></a>
                                    <a href="{{ url('admin/blogs-sub-category-delete/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete" title="delete data"><i class="fa fa-trash"></i></a>
                                    @if($row->status == 1)
                                    <a href="{{ url('admin/blogs-sub-category-inactive/'.$row->id) }}" class="btn btn-sm btn-danger" title="Click to Inactive"><i class="fa fa-arrow-down"></i></a>
                                    @else 
                                    <a href="{{ url('admin/blogs-sub-category-active/'.$row->id) }}" class="btn btn-sm btn-success" title="click to active"><i class="fa fa-arrow-up"></i></a>
                                    @endif
                                  </td>
                                </tr>                               
                                @endforeach
                ...
                <div class="col-md-4">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <hr>
                          <form action="{{ route('store-blog-subcategory') }}" method="POST" >
                              @csrf
                              <div class="form-group">
                                ...
                                <select name="category_id" id="exampleInputEmail1" class="form-control  @error('category_id') is-invalid @enderror">
                                  ...
                                  <option value="{{ $row->id }}">{{ ucwords($row->category_name_en )}}</option>
                                  @empty 
