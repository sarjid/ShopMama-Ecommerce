                ...
                <div class="col-md-12 m-auto">
                  <div class="mailbox-content">
                    <nav class="breadcrumb sl-breadcrumb">
                      ...
                      <a class="breadcrumb-item" href="#">Inbox</a>
                      <a class="breadcrumb-item" href="#">Messages</a>
                    </nav>
                    <table class="table table-hover mg-t-25 mg-b-0">
                      <a href="{{ url('admin/trash/message') }}" class="btn btn-sm btn-danger pull-right">  <i class="icon ion-ios-folder-outline tx-20"></i> Trash Box</a>
                      <tbody>
