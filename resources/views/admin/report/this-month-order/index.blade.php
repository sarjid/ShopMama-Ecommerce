...
@section('this-month-orders') active @endsection
@section('admin_title') this month Orders @endsection
@section('admin_content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
          ...
          <span class="breadcrumb-item active">this month Orders</span>
        </nav>
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">{{ Carbon\Carbon::now()->format('F') }} month Order Total: {{ count($orders) }}</div>
