...
@section('todays-orders') active @endsection
@section('admin_title') todays Orders @endsection
@section('admin_content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
          ...
          <span class="breadcrumb-item active">todays Orders</span>
        </nav>
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">todays Order Total: {{ count($orders) }}</div>
