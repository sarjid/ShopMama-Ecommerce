...
@section('admin_title') Pending Orders @endsection
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">New Order Total: {{ count($orders) }}</div>
                          ...
                          <table id="datatable1" class="table display responsive nowrap ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>                
                                    <a href="{{ URL::to('admin/orders/pending-order/view/'.$row->id) }}" class="btn btn-sm btn-primary"  title="Order View"><i class="fa fa-eye"></i> View</a>
                                </td>
