...
@section('admin_title') shipped Orders @endsection
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">shipped Total: {{ count($orders) }} Orders</div>
                          ...
                          <table id="datatable1" class="table display responsive nowrap ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>                
                                    <a href="{{ URL::to('admin/shipped-orders/view/'.$row->id) }}" class="btn btn-sm btn-primary"  title="Order View"><i class="fa fa-eye"></i> View</a>
                                </td>
