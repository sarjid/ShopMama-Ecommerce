...
@section('admin_title') Confirm Orders @endsection
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">Confirm Total: {{ count($orders) }} Orders</div>
                          ...
                          <table id="datatable1" class="table display responsive nowrap ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>                
                                    <a href="{{ URL::to('admin/confirm-orders/view/'.$row->id) }}" class="btn btn-sm btn-primary"  title="Order View"><i class="fa fa-eye"></i></a>
                                    
                                    <a href="{{ url('admin/order/invoice/'.$row->id) }}" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o" style="font-size:20px;color:white;"></i></a>
                                </td>
