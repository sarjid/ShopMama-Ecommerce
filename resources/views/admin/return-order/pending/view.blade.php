...
@section('admin_title') View return Pending Orders @endsection
@section('admin_content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
          ...
          <span class="breadcrumb-item active">View return Pending Orders</span>
        </nav>
        ...
        <div class="sl-pagebody">
          <div class="row row-sm">
            ...
            <a href="{{ url('admin/return-request-orders/accept/'.$order->id) }}" class="btn btn-success mb-3" style="cursor: pointer;">Accept Request Order</a>
       
            <a href="{{ url('admin/return-request-orders/cancel/'.$order->id) }}" type="submit" style="cursor: pointer;"  class="btn btn-danger mb-3" id="">Cancel Return Order</a>
