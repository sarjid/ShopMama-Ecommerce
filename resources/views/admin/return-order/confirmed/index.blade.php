...
@section('return-confirmed-orders') active @endsection
@section('admin_title') return confirmed Orders @endsection
          ...
          <div class="row row-sm">
                <div class="col-md-12 ">
                    <div class="card pd-20 pd-sm-40 ">
                        <div class="text-danger">Return confirmed Order Total: {{ count($orders) }}</div>
                        <h6 class="card-body-title">Return confirmed List                
                        </h6>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <span class="badge badge-success">Accept Return Request</span>
                                  @else
                                ...
                                <td>                
                                    <a href="{{ URL::to('admin/return-confirmed-orders/view/'.$row->id) }}" class="btn btn-sm btn-primary"  title="Order View"><i class="fa fa-eye"></i> View</a>
                                </td>
