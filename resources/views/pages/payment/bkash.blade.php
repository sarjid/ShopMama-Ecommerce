...
<div class="body-content">
	<div class="container">
		<div class="checkout-box ">
            <div class="row">
                <form action="{{ url('bkash/order/store') }}" method="post">
                    @csrf
                <div class="col-md-4">
								...
								<div class="">
									<ul class="nav nav-checkout-progress list-unstyled">
                                        ...
                                        @if (Session::has('coupon'))
											...
											<h4 class="text-center" style="margin-top: 5px; margin-bottom: 5px;"><strong> Total Amount: </strong>৳{{ $ort = round($total - session()->get('coupon')['coupon_balance']) }} </h4>
											<small class="text-danger" style="margin-left:70px;">Per 1K BKash Charge 18.50tk ( ৳{{$rkcrg = round($ort*0.0185) }} )</small> <hr>
											<h4 class="text-center" style="margin-top: 5px; margin-bottom: 5px;"><strong> Paying Amount: </strong>৳{{ $pay = ($ort + $rkcrg) }} </h4>
                                        @else
											<h4 class="text-center" style="margin-top: 5px;"><strong>BKash Charge: </strong> ৳{{$rkcrg = round($total*0.0185) }} </h4>
											<small class="text-danger" style="margin-left:70px;">Per 1K BKash Charge 18.50tk ( ৳{{$rkcrg = round($total*0.0185) }} )</small> <hr>
					...
					<div class="panel-group checkout-steps" id="accordion">
                        ...
                        <div class="panel panel-default checkout-step-01">
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                             <div class="form-group">
                                                <label class="info-title" for="exampleInputEmail1">	@if (session()->get('language') == 'bangla') বিকাশ নাম্বার BKash @else Number @endif<span>*</span></label>
                                                <input type="text" disabled name="" id="" class="form-control" value="01722260010">
                                           ...
                                           <div class="col-md-4">
                                            <div class="form-group">
												<label class="info-title" for="exampleInputEmail1">Your Paying Number<span>*</span></label>
												<input type="text"  name="payment_number" id="exampleInputEmail1" class="form-control" value="{{ old('payment_number') }}" placeholder="i paid from this number">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="info-title" for="exampleInputEmail1">Transaction ID<span>*</span></label>
                                              <textarea name="transaction_id" id="exampleInputEmail1" cols="40" rows="5" placeholder="your payment transaction id "></textarea>
